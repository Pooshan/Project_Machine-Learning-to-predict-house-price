...
class decisionTree:
    ...
    def decision_tree_algo(self):
        ...
        for n in n_array:
            ...
            # With Boosting
            model_boost = AdaBoostRegressor(DecisionTreeRegressor(max_depth=n))
            ...
            # With Bagging
            model_bag = BaggingRegressor(DecisionTreeRegressor(max_depth=n))
            ...
            print('Completed for {0} max-depth'.format(n))
